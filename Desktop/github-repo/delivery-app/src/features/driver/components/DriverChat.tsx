...
export default function DriverChat({
  ...
  useEffect(() => {
    ...
    const connect = () => {
      ...
      ws.onmessage = (e) => {
        ...
        try {
          ...
          if (data.type === "history") {
            ...
            if (data.user_id !== user?.id) onUnread();
      ...
      ws.onerror = () => {
        if (isMounted) setConnectionError("Connection error. Retrying...");
      };
      ...
      ws.onclose = (e) => {
        ...
        if (e.code === 4001) {
          ...
          setClosed(true);
          setClosedReason("Chat is only available during active deliveries.");
        } else if (e.code === 4004) {
          setClosed(true);
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 shrink-0">
          <div className="flex items-center gap-2">
            ...
            />
            <p className="text-light text-sm font-semibold">Chat with sender</p>
